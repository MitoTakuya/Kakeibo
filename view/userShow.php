	...
	<div class="container">
		...
		<div class="box" style="border-radius: 10px;">
			<div class="card-header bg-white">
				<div class="check">
					<h5><i class="fas fa-desktop"></i> ユーザー情報</h5>
				</div>
			</div>
			<div class="card-body">
				<div class="card-text">
					<div class="check">
						<h5><i class="fas fa-pen"></i> ログイン中ユーザー</h5>
					</div>
					<div class="ml-4">
						<h5><span>
								<img src="../images/<?php echo Config::h($current_user['user_image']); ?>"
									border-radius="50%" alt="アイコン画像" style="height:50px;width:50px;border-radius:50%" />
								<?php echo Config::h($current_user['user_name']); ?><span
									class="float-right">
									<button type="button" class="btn btn-primary"
										onclick="location.href='userUpdate.php'">
										更新する</button></span>
						</h5>
					</div>
					<div class="mt-4"></div>
					...
					<?php
                        foreach ($other_users as $row) {
                            ?>
					<div class="check">
						<h5><i class="fa fa-user"></i> グループメンバー</h5>
					</div>
					<div class="ml-4">
						<h5><span>
		...
		<div class="box" style="border-radius: 10px;">
			<div class="card-header bg-white">
				<div class="check">
					<h5><i class="fas fa-calculator"></i> グループ情報</h5>
				</div>
			</div>
			<div class="card-body">
				<div class="card-text" id="groupCard">
					...
					<div class="check">
						<h5><i class="fas fa-piggy-bank"></i> 目標貯金額</h5>
					</div>
					<div class="ml-4">
