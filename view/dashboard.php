        ...
        <div class="container">
            <div class="mx-auto">
                ...
                <div class="card card_property">
                    ...
                    <!-- カードheader部分 -->
                    <div class="row">
                        <svg class="card-img-top" width="320" height="75" xmlns="http://www.w3.org/2000/svg"
                            focusable="false" role="img">
                            <rect width="100%" height="100%" fill="#87CEEB" />
                            <text class="mx-auto h3" x="50%" y="50%" fill="#ffffff" dy=".5em"
                                text-anchor="middle"><?= $displayed_year_month ?> の支出</text>
                        </svg>
                    </div>
                    ...
                    <div>
                        <form action="#" method="post" :ref="selecting_date">
                            <select class="w-25 form-control select_period text-left float-right" name="date"
                                v-model="selected_date" @input="selfPostDate">
                                <option disabled value="">--月を選択--</option>
                                <option v-for="date in selectable_dates" :value="date.year_month">
                                    {{date.year}}年{{date.month}}月</option>
                            </select>
                        </form>
                    </div>
                    ...
                    <div class="outgo_chart card-body">
                        ...
                        <table class="table w-100">
                            ...
                            <tr>
                                ...
                                <!-- 支出金額 -->
                                <td scope="row"><?= number_format($outgo['payment']) ?>
                                    円</td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <!-- 収入金額 -->
                                <td scope="row"><?= number_format($income['payment']) ?>
                                    円</td>
                            </tr>
                            <?php endforeach; ?>
                            <?php endif; ?>
