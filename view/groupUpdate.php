			...
			<div class="box" style="border-radius: 10px;">
				...
				<form method="POST" action="" enctype="multipart/form-data">
					<input type="hidden" name="id"
						value="<?php echo Config::h($row['id']); ?>">
					<input type="hidden"
					...
					<div class="form-group">
						<p><i class="fas fa-user-group"></i>
							...
							<input type="text" id="group_name" name="group_name" class="form-control"
								value="<?php echo Config::h($row["group_name"]); ?>">
					...
					<div class="form-group">
						<p><i class="fas fa-piggy-bank"></i>
							...
							<input type="number" id="goal" name="goal" class="form-control" min="0"
								value="<?php echo Config::h($row["goal"]); ?>">
