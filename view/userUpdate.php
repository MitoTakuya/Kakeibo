        ...
        <div class="container">
            ...
            <div class="mx-auto">
                ...
                <span class="input-group-addon ">
                    <p><i class="fas fa-desktop"></i> ユーザー情報更新</p>
                </span>
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <p><i class="fas fa-pen"></i>
                        ...
                        value="<?php echo Config::h($current_user["user_name"]); ?>" required>
                    ...
                    <div class="form-group">
                        <p><i class="far fa-envelope"></i>
                            ...
                            <input type="email" id="mail" name="mail" class="form-control"
                                value="<?php echo Config::h($current_user["mail"]); ?>">
                ...
                <form action="" method="post">
                    <input type="submit" class="btn btn-block btn-lg btn-outline-danger" name="<?php echo $_SESSION['id']; ?>"
                        value="退会する" name="user_update"  onclick="return deleteFunc()">
                </form>
                </div>
            </div>  
        </div>
